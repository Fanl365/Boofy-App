...
We are improving the ways that we reward all contributors in the Boofy community. We try to be as fair as possible and use the treasury in an effective manner.
...
4. If you are a dev with some cred with Boofy, you can propose a regular reward for continued contributions. 

## Steps

### 1. Fill out a proposal
Go to [vote.boofy.finance](https://vote.boofy.finance) and click on the big square that says "Boofy.Finance". Once you're in, click on the [New Proposal](https://vote.boofy.finance/#/boofy/create) button.
...
It's important for Boofy because...<BODY_OF_PROPOSAL>
...
The #development channel is a good place to get the attention of other boofy devs. If you can post in #citadel, that's a great place to get the atention influential members of Boofy as well.
