        ...
        <Grid className={classes.faq} item xs={12} lg={9}>
          <Accordion square expanded={expanded === 'faq-1'} onChange={handleChange('faq-1')}>
            <AccordionSummary expandIcon={<ExpandMoreIcon />}>
              <Typography>How do I use Boofy Launchpool?</Typography>
            </AccordionSummary>
            <AccordionDetails>
              <Typography>
                <img
                ...
                to the related partner Launchpool vault here on the Boofy Launchpool site and enter
          ...
          <Accordion square expanded={expanded === 'faq-7'} onChange={handleChange('faq-7')}>
            ...
            <AccordionDetails>
              <Typography>
                A mooToken can be seen as a receipt that you get when depositing into any Boofy vault.
                This is a fully automatic process. For example, you receive ‘mooBIFI’ tokens from
                depositing $BIFI into the Boofy Maxi vault. These mooTokens do not 1:1 represent the
                ...
                Boofy.Finance users should hold on tightly to the mooTokens i.e. deposit receipts
          ...
          <Accordion square expanded={expanded === 'faq-9'} onChange={handleChange('faq-9')}>
            ...
            <AccordionDetails>
              <Typography>
                mooBIFI is the token you receive from depositing $BIFI into the Boofy Maxi vault.
                These mooTokens do not 1:1 represent the token amount initially deposited but it
                does represent the value of your share in the vault. The Boofy Maxi vault gathers a
                performance fee from every Boofy Vault when they are harvested, and uses it to buy
                more $BIFI and redeposit in the vault. The more profit the Boofy generates, the more
          ...
          <Accordion square expanded={expanded === 'faq-10'} onChange={handleChange('faq-10')}>
            ...
            <AccordionDetails>
              <Typography>
                Yes! These partner vaults are hosted by Boofy and are completely safe. Boofy has
                gotten tokens from our partners and uses our own vaults for the reward. Those
                mooTokens your stake doesn’t leave Boofy.
              </Typography>
            </AccordionDetails>
          </Accordion>
          ...
          <Accordion square expanded={expanded === 'faq-12'} onChange={handleChange('faq-12')}>
            ...
            <AccordionDetails>
              <Typography>
                ...
                Rate” and is a fixed rate. Boofy shows APR by dividing the annual yield into 365
                days and presents that to you as “Daily”. APY on the other hand means “Annual
                percentage yield” which is when you take the daily yield and compound it. Boofy
          ...
          <Accordion square expanded={expanded === 'faq-14'} onChange={handleChange('faq-14')}>
            ...
            <AccordionDetails>
              <Typography>
                When partnering with a certain project, Boofy always tries to make an overall check
                ...
                Boofy cannot, and will not take any responsibility for your personal actions.
              </Typography>
            </AccordionDetails>
          </Accordion>
          {appNetworkId === 56 ? (
