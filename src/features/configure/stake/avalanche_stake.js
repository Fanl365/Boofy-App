    ...
    partners: [
      {
        logo: 'stake/boofy/boofyfinance.png',
        background: 'stake/boofy/background.png',
        text: 'beJOE is Boofy Staked JOE. The token is pegged to JOE and can be staked on the Boofy platform to earn JOE or more beJOE. beJOE gives stakers access to 5% of all Boofy Trader Joe Boosted farm rewards. You can burn beJOE for JOE if there is available JOE reserves.',
