...
export const fantomStakePools = [
    ...
    partners: [
      {
        ...
        text: "Boofy Finance is The Multi-Chain Yield Optimizer across many blockchains, enabling users to earn autocompounded yield on their crypto. Did you know also that you can own a piece of Boofy itself? Boofy runs on its governance token, BIFI. The token has a set supply of 80,000 across all chains; no more may be minted, ever! As a holder of BIFI you may create and vote on important DAO proposals, and you become dividend-eligible to earn a share of every compounding harvest on Boofy vaults, hour by hour. Here on Fantom, you just need to stake BIFI in this reward pool, or in the autocompounding BIFI Maxi vault on the main page. For this pool, FTM dividends are gathered and sent proportionally to each staker. Stake here, return later to claim the FTM you've earned.",
    ...
    partners: [
      {
        logo: 'stake/boofy/boofyfinance.png',
        background: 'stake/boofy/background.png',
        text: 'beFTM simply means Boofy Escrowed Fantom. The token is pegged to FTM and can be staked on the Boofy platform and farms on major DEXs. beFTM gives stakers access to maximized validator rewards that typically aren’t available to the individual investor without locking FTM for 1 year.',
        website: 'https://app.boofy.finance',
        social: {
          telegram: 'http://t.me/boofyfinance',
          twitter: 'https://twitter.com/boofyfinance',
...

  {
    ...
    name: 'Hector (TOR)',
    assets: ['TOR', 'FTM'],
    token: 'mooSpookyTOR-FTM',
    tokenDecimals: 18,
    tokenAddress: '0xf723aE5478B1F03cA88C204F1ae5498d3576B78F',
    tokenOracle: 'lps',
    tokenOracleId: 'boo-wftm-tor',
    earnedToken: 'HEC',
...

  {
    ...
    earnedToken: 'TOR',
    earnedTokenDecimals: 18,
    earnedTokenAddress: '0x74E23dF9110Aa9eA0b6ff2fAEE01e740CA1c642e',
    earnContractAddress: '0x9A18B566355d394D67693c4C2d269c524c7Eb182',
    earnContractAbi: govPoolABI,
    earnedOracle: 'tokens',
    earnedOracleId: 'TOR',
    partnership: true,
  ...
  {
    id: 'moo_hector-tor-crv-hector',
    name: 'Hector (TOR)',
    logo: 'fantom/TOR-2CRV.svg',
    token: 'mooHectorTOR-2CRV',
    tokenDecimals: 18,
    tokenAddress: '0x8B92DE822b121761a3caF894627a09a9f87864C0',
    tokenOracle: 'lps',
    tokenOracleId: 'hector-tor-crv',
    earnedToken: 'TOR',
    earnedTokenDecimals: 18,
    earnedTokenAddress: '0x74E23dF9110Aa9eA0b6ff2fAEE01e740CA1c642e',
    earnContractAddress: '0xC370B3a3958579F2aAFedF4c3548F75DeB43DB11',
    earnContractAbi: govPoolABI,
    earnedOracle: 'tokens',
    earnedOracleId: 'TOR',
    partnership: true,
    ...
    partners: [
      {
        ...
        text:
          ...
          'Lock your SPIRIT on Boofy to mint binSPIRIT, Boofy’s liquid version of inSPIRIT. Staking it directly on Boofy gives you compounded interest on your SPIRIT and also allows you to exchange it at any time. \n' +
          'Deposit your mooBinSPIRIT (receipt for binSPIRIT deposited in our vaults) into the boost to earn mooBIFI.',
        website: 'https://app.boofy.finance/',
        social: {
          telegram: 'https://discord.gg/boofyfinance',
          twitter: 'https://twitter.com/boofyfinance',
        },
      },
    ],
