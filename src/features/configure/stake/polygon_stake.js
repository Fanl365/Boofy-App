...
export const polygonStakePools = [
    ...
    partners: [
      {
        ...
        text: "Boofy Finance is The Multi-Chain Yield Optimizer across many blockchains, enabling users to earn autocompounded yield on their crypto. Did you know also that you can own a piece of Boofy itself? Boofy runs on its governance token, BIFI. The token has a set supply of 80,000 across all chains; no more may be minted, ever! As a holder of BIFI you may create and vote on important DAO proposals, and you become dividend-eligible to earn a share of every compounding harvest on Boofy vaults, hour by hour. Here on Polygon, you just need to stake BIFI in this reward pool, or in the autocompounding BIFI Maxi vault on the main page. For this pool, MATIC dividends are gathered and sent proportionally to each staker. Stake here, return later to claim the MATIC you've earned.",
    ...
    partners: [
      {
        logo: 'stake/boofy/boofyfinance.png',
        background: 'stake/boofy/background.png',
        text: 'beQI is Boofy Staked QI. The token is pegged to QI and can be staked on the Boofy platform to earn QI or more beQI. beQI gives stakers access to max lock rewards of staking QI for eQI. You can burn beQI for QI if there is available QI reserves.',
        website: 'https://boofy.com',
        social: {
          telegram: 'http://t.me/boofyfinance',
          twitter: 'https://twitter.com/boofyfinance',
        },
...

  {
    ...
    name: 'Jarvis',
    assets: ['JRT', 'ETH'],
    token: 'mooSushiJRT-ETH',
    tokenDecimals: 18,
    tokenAddress: '0xfdE69969f4527343D78F9C9AC797ded29098B215',
    tokenOracle: 'lps',
    tokenOracleId: 'sushi-jrt-eth',
