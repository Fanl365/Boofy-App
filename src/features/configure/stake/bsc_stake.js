...
const moonpot = {
  ...
  text: 'Moonpot is a win-win savings game on Binance Smart Chain powered by Boofy Finance. By depositing crypto into a Moonpot, users gain interest on their assets and enter into a prize draw at the same time. There’s a chance to win weekly prizes paid out in crypto from each Moonpot entered — as well as an exclusive monthly prize draw for $POTS stakers.',
...
export const bscStakePools = [
  {
    ...
    earnContractAddress: '0x0d5761D9181C7745855FC985f646a842EB254eB9',
    ...
    partners: [
      {
        ...
        text: "Boofy Finance is The Multi-Chain Yield Optimizer across many blockchains, enabling users to earn autocompounded yield on their crypto. Did you know also that you can own a piece of Boofy itself? Boofy runs on its governance token, BIFI. The token has a set supply of 80,000 across all chains; no more may be minted, ever! As a holder of BIFI you may create and vote on important DAO proposals, and you become dividend-eligible to earn a share of every compounding harvest on Boofy vaults, hour by hour. Here on Binance, you just need to stake BIFI in this reward pool, or in the autocompounding BIFI Maxi vault on the main page. For this pool, BNB dividends are gathered and sent proportionally to each staker. Stake here, return later to claim the BNB you've earned.",
...

  {
    ...
    name: 'Bomb.money',
    assets: ['BTCB', 'ETH'],
    token: 'mooBiSwapETH-BTCB',
    tokenDecimals: 18,
    tokenAddress: '0xEeB87e7bAbF17cA97F0Eb897F24Bf475e0A9Aef7',
    tokenOracle: 'lps',
    tokenOracleId: 'biswap-eth-btcb',
    earnedToken: 'BOMB',
    earnedTokenDecimals: 18,
...

  {
    ...
    name: 'Biswap',
    assets: ['USDT', 'BUSD'],
    token: 'mooBiSwapUSDT-BUSD',
    tokenDecimals: 18,
    tokenAddress: '0x164fb78cAf2730eFD63380c2a645c32eBa1C52bc',
    tokenOracle: 'lps',
    tokenOracleId: 'biswap-usdt-busd',
    earnedToken: 'BSW',
    earnedTokenDecimals: 18,
...

  {
    ...
    token: 'mooBIFIV2',
    tokenDecimals: 18,
    tokenAddress: '0x7828ff4ABA7aAb932D8407C78324B069D24284c9',
    tokenOracle: 'tokens',
    tokenOracleId: 'BIFI',
    earnedToken: 'ESHARE',
    earnedTokenDecimals: 18,
    ...
    partners: [
      {
        ...
        logoNight: 'stake/boofy/boofyfinance_night.png',
        background: 'stake/boofy/background.png',
        text: 'Boofy Finance is the Multichain Yield Optimizer that allows its users to earn compound interest on their holdings. A yield optimizer is an automated service that seeks to gain the maximum possible return on crypto-investments made through DeFi platforms. This is much more efficient than attempting to maximize your returns by doing everything manually. It also means you don’t have to sit in front of a screen all day. So Boofy Finance is a platform that puts your crypto to work for maximum ROI with minimum effort. $BIFI is the governance token of the Boofy Finance platform. This means that when you own some $BIFI, you get the right to create and vote on proposals to do with the future of the platform. Third, the fun part: $BIFI tokens can be staked on Boofy to earn a share of the revenue created by the Boofy platform.',
        website: 'https://app.boofy.finance',
        social: {
          telegram: 'http://t.me/boofyfinance',
          twitter: 'https://twitter.com/boofyfinance',
