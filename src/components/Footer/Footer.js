  ...
  return (
    <div className={classes.root}>
      <div className={classes.column}>
        <div className={classes.title}>boofy.finance</div>
        <a
          href="https://docs.boofy.finance"
          target="_blank"
        ...
        <a
          href="https://blog.boofy.finance/articles"
          target="_blank"
          rel="noopener noreferrer"
          className={classes.link}
        >
        ...
        <a
          href="https://forum.boofy.finance/"
          target="_blank"
          rel="noopener noreferrer"
          className={classes.link}
        >
        ...
        <a
          href="https://github.com/boofyfinance"
          target="_blank"
          rel="noopener noreferrer"
          className={classes.link}
        >
      ...
      <div className={classes.column}>
        ...
        <a
          href="https://twitter.com/boofyfinance"
          target="_blank"
          rel="noopener noreferrer"
          className={classes.link}
        >
